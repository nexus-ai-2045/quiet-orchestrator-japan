...
初期値、施策delta、危機寄与selectorの重み、開示コスト等の副作用表現、画面の視覚密度は、2026-08-24にハッカソン体験検証用v0として人間採用された。値の正本と変更ゲートは[架空係数 Calibration v0](docs/calibration-v0.md)に置く。役割同等fixtureによる国名・接続ID非依存の回帰検査は実装済みで、残るM1機械作業は完全な因果台帳drawerである。
