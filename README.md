...
<p align="center">
  <img src="docs/images/simulator-preview.jpg" width="1200" alt="2026年から2045年までの接続を育てるシミュレーター画面">
  <br>
  <sub>実装済みMVP — 2035年の接続状態、18主体、5施策、72時間テストを同じ画面で比較</sub>
</p>

| 長期準備 | 危機試験 | 比較単位 | 2045年の成功条件 |
|---|---|---|---|
| 2026 → 2045 | 6時間 × 12ターン | 18主体・5施策 | 日本が中心から退いても協調が続く |
