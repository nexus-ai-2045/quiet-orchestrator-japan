...
本作が「メタ安全保障」の概念原典として扱う公開文書は、次の公式掲載面と、そこから直接リンクされる片山俊大氏の構想ペーパー（Version 1.0）である。

| 役割 | 発行・掲載 | 公式URL |
|---|---|---|
| ハッカソンのテーマ・応募要件 | AUTOMATA | [AIエージェント社会シミュレーションハッカソン Vol.2](https://hackathon.automata-lab.jp/) |
| メタ安全保障の概念原典 | 片山俊大 / Singulabo・AUTOMATA | [メタ安全保障 構想ペーパー](https://prtimes.jp/a/?f=d80352-184-caedebb354dd205d5811c599da74761b.pdf) |

ローカルに保管されたDOCXや内部要約PDFは、この公開版の出典や配布物に含めない。公開版は上記URLへリンクし、第三者文書本文を転載しない。

## 2. 日本：領域語彙と初期条件

| モデル化する事項 | 公開主体 | 公式URL | 使い方 |
|---|---|---|---|
| 外交・防衛・経済安全保障・技術・サイバー・海洋・宇宙・情報を含む国家安全保障上の語彙 | 内閣官房 | [国家安全保障戦略（令和4年12月16日）](https://www.cas.go.jp/jp/siryou/221216anzenhoshou.html) / [本文PDF](https://www.cas.go.jp/jp/siryou/221216anzenhoshou/nss-j.pdf) | 隣接領域の名称だけを参照する |
| 陸・海・空と宇宙・サイバー・電磁波を横断する考え方 | 防衛省 | [領域横断作戦能力の強化](https://www.mod.go.jp/j/press/wp/wp2025/html/n310204000.html) | 通信・測位・電磁波の波及を置く |
| 尖閣周辺での海警船確認状況 | 海上保安庁 | [海上保安レポート2025](https://www.kaiho.mlit.go.jp/info/books/report2025/html/honpen/3_03_chap2.html) | 海上接触を常態的背景として置く |
| 重要インフラを含むサイバー脅威 | 警察庁 | [2025年上半期におけるサイバー空間をめぐる脅威の情勢等](https://www.npa.go.jp/publications/statistics/cybersecurity/data/R7kami/R07_kami_cyber_jyosei.pdf) | 障害原因を断定せず複数seedに分ける |

三相（物理／経済・産業／認知・文化）はハッカソン用の観測系であり、日本政府の公式領域分類ではない。
...
中国側の自己説明と日本政府の評価は同じ種類の情報ではない。モデルでは発表主体を保持し、いずれも秘密の指揮系統や将来行動の証拠として扱わない。

## 5. 利用規律

- 公式URLは、役割、用語、観測事実を参照するために使い、政策採用や正当性の証明に使わない。
- 観測事実、発表主体の評価、シミュレーション上の推論を混同しない。
- URL、文書日付、組織名は公開前に再確認する。
- 実在組織の非公開情報、個人名、将来の意思、具体的作戦能力を推定して補わない。
