...
- content HEAD: `90a8ae9349d9420c482ed22cefa0e66fa054cffd`（M2〜M5ローカルMVP、根因収束、135件回帰、Sites 4件、build、audit 0）
...
| 決定論・AI・UI境界テスト | pass | `npm test`: 135件pass。M2〜M5、120ターン危機再生、A〜E・5 seed・2045年日本除去境界、権限拒否証拠、run bundle、台帳drawerを回帰固定 |
...
```json
{"schemaVersion":1,"status":"pass","intent":"ready_after_confirmation","contentHead":"90a8ae9349d9420c482ed22cefa0e66fa054cffd","secretCandidates":0,"personalPaths":0,"origin":"pass","cleanWorktree":true,"ciConfigCount":2,"effectiveIdentity":"pass","historyMismatchCount":2,"effectiveMismatchCount":0}
```
