...
- content HEAD: `02b2296e4b705a46d7c069db2ec60d5679a815db`（annual deterministic replay、action/history/ledger完全projection、全年度checkpoint束縛、legacy保存fail-closed、definition単一入口、checkpoint完全projection、Canonical event順序、107件回帰）
...
| 決定論・AI・UI境界テスト | pass | `npm test`: 107件pass。提案・receipt・PDCAに加え、annual deterministic replay、action/history/ledger完全projection、全年度checkpoint束縛、legacy保存fail-closed、definition単一入口、checkpoint完全projection、Canonical event順序、台帳drawer、校正・migration・最終checkpointを回帰固定 |
...
```json
{"schemaVersion":1,"status":"pass","intent":"ready_after_confirmation","contentHead":"02b2296e4b705a46d7c069db2ec60d5679a815db","secretCandidates":0,"personalPaths":0,"origin":"pass","cleanWorktree":true,"ciConfigCount":2,"effectiveIdentity":"pass","historyMismatchCount":2,"effectiveMismatchCount":0}
```
