...
- content HEAD: `01cc32843d9211959a385144c4e1978b2a6eada8`（M2ポートフォリオfail-closed、非空relationship ID、必須label・校正済み接続・整数year境界、Boolean metadata、stressのportfolio検証、default-branch provenance同期、76件回帰）
