...
- content HEAD: `1e3ad0317ca8809a3b85082cc8cde6c389088d71`（annual deterministic replay、action/history/ledger完全projection、全年度checkpoint束縛、legacy保存fail-closed、再生前入力境界、105件回帰）
...
| 決定論・AI・UI境界テスト | pass | `npm test`: 105件pass。提案・receipt・PDCAに加え、annual deterministic replay、action/history/ledger完全projection、全年度checkpoint束縛、legacy保存fail-closed、割当て・参照前の入力検証、台帳drawer、校正・migration・最終checkpointを回帰固定 |
...
```json
{"schemaVersion":1,"status":"pass","intent":"ready_after_confirmation","contentHead":"1e3ad0317ca8809a3b85082cc8cde6c389088d71","secretCandidates":0,"personalPaths":0,"origin":"pass","cleanWorktree":true,"ciConfigCount":2,"effectiveIdentity":"pass","historyMismatchCount":2,"effectiveMismatchCount":0}
```
