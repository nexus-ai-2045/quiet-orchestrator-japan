...
- content HEAD: `3c10134ed44f0ee906e4662525096b1f67a53d7b`（M2二層fail-closed、execution state metrics/container/schema、distinct endpoints、識別可能SHA provenance、非空relationship ID、78件回帰）
...
```json
{"schemaVersion":1,"status":"pass","intent":"ready_after_confirmation","contentHead":"3c10134ed44f0ee906e4662525096b1f67a53d7b","secretCandidates":0,"personalPaths":0,"origin":"pass","cleanWorktree":true,"ciConfigCount":2,"effectiveIdentity":"pass","historyMismatchCount":2,"effectiveMismatchCount":0}
```
