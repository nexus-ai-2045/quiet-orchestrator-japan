...
- content HEAD: `f4bae46d4f0940aff70e38dbc9ba87276ca2abe3`（履歴証拠。現candidateではM2・M3とM4危機再生を追加し121件回帰）
...
| 決定論・AI・UI境界テスト | pass | `npm test`: 121件pass。M4 120ターン危機再生、提案・承認・実行権限と拒否証拠、全18主体の国名非依存制約型、全20接続のarchetype校正、annual replay、run bundle、台帳drawerを回帰固定 |
