...
- content HEAD: `d57643d04dc9dda62c08850a711c676524eefeb5`（M2ポートフォリオfail-closed、必須label・校正済み接続・整数year境界、Boolean metadata、stressのportfolio検証、default-branch provenance同期、75件回帰）
